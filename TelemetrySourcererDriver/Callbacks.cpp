...
CALLBACK_SEARCH_QUERY LoadImageCallbackQueries[15] = {
	...
	{ WINDOWS_INDEX::WX_19043, RTL_CONSTANT_STRING(L"PsSetLoadImageNotifyRoutineEx"),       RTL_CONSTANT_STRING(L"PsSetCreateProcessNotifyRoutine"),           LI_PATTERN_WX_10240, sizeof(LI_PATTERN_WX_10240), -4 },
};
...
CALLBACK_SEARCH_QUERY CreateProcessCallbackQueries[15] = {
	...
	{ WINDOWS_INDEX::WX_19043, RTL_CONSTANT_STRING(L"PsSetCreateProcessNotifyRoutine"),     RTL_CONSTANT_STRING(L"IoCreateDriver"),                            CP_PATTERN_WX_16299, sizeof(CP_PATTERN_WX_16299), -4 },
};

UCHAR CT_PATTERN_W7_07600[] = { 0xbf, 0x40, 0x00, 0x00, 0x00, 0x48, 0x8b, 0xcb, 0xe8 };
UCHAR CT_PATTERN_WX_10240[] = { 0x48, 0x8b, 0xcd, 0xe8 };
CALLBACK_SEARCH_QUERY CreateThreadCallbackQueries[15] = {
	...
	{ WINDOWS_INDEX::WX_19043, RTL_CONSTANT_STRING(L"PsRemoveCreateThreadNotifyRoutine"),   RTL_CONSTANT_STRING(L"PsRemoveLoadImageNotifyRoutine"),            CT_PATTERN_WX_10240, sizeof(CT_PATTERN_WX_10240), -8 },
};
...
CALLBACK_SEARCH_QUERY RegistryCallbackQueries[15] = {
	...
	{ WINDOWS_INDEX::WX_19043, RTL_CONSTANT_STRING(L"CmUnRegisterCallback"),                RTL_CONSTANT_STRING(L"DbgkLkmdUnregisterCallback"),                RG_PATTERN_WX_10240, sizeof(RG_PATTERN_WX_10240), -9 },
};
...
CALLBACK_SEARCH_QUERY ObjectCallbackQueries[15] = {
	...
	{ WINDOWS_INDEX::WX_19043, RTL_CONSTANT_STRING(L"ObCreateObjectType"),                  RTL_CONSTANT_STRING(L"IoCreateDriver"),                            OB_PATTERN_WX_10240, sizeof(OB_PATTERN_WX_10240), 25 },
};
